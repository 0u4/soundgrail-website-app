! function(t) {
  ...
  "+/gs": function(t, e, n) {
    e = t.exports = n("FZ+f")(void 0), e.push([t.i, "td[data-v-9866be0a]{width:220px}.p20[data-v-9866be0a]{padding:20px}", ""])
  },
  "+66z": function(t, e) {
    function n(t) {
      return o.call(t)
  ...
  "/Z8c": function(t, e, n) {
    ...
    var r = ["major", "minor", "dim", "5", "7", "maj7", "min7"],
      o = {
        e: "e",
        B: "B",
        G: "G",
  ...
  "2EeS": function(t, e, n) {
    ...
    var o = n("VU/8")(n("Xaou"), n("497e"), r, "data-v-9866be0a", null);
    t.exports = o.exports
  },
  "2Ero": function(t, e, n) {
    e = t.exports = n("FZ+f")(void 0), e.push([t.i, ".footer[data-v-1115a3a6]{max-height:10px;padding:30px 5px 60px;border-top:1px solid #d3d6db;bottom:0;width:100%}.fixed[data-v-1115a3a6]{position:fixed}", ""])
  },
  "3IRH": function(t, e) {
  ...
  "497e": function(t, e) {
    t.exports = {
      render: function() {
        ...
        }, t._l(t.bars, function(e) {
          return n("tr", t._l(e, function(e) {
            return n("td", {
              staticClass: "is-centered",
              class: {
                p20: t.progression.length <= 8
              }
            }, [n("span", [t._v(t._s(e.join(" | ")))])])
          }))
        }))])
      },
      staticRenderFns: []
    ...
    t.exports = {
      render: function() {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return n("span", [t._l(t.chordShapes, function(e, r) {
          return t.showChordNames ? n("span", {
            key: r,
            staticClass: "tab-label"
          }, [t._v(t._s(r > 0 ? " | " : "") + "\n" + t._s(e.name) + "\n")]) : t._e()
        }), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.e)))]), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.B)))]), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.G)))]), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.D)))]), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.A)))]), n("span", {
          staticClass: "tab-line"
        }, [t._v(t._s(t.draw(t.strings.E)))])], 2)
      },
      staticRenderFns: []
    }
  },
  ...
  "7e4z": function(t, e, n) {
    function r(t, e) {
      var n = a(t),
        ...
        h = v.length;
      for (var m in t) !e && !l.call(t, m) || d && ("length" == m || f && ("offset" == m || "parent" == m) || p && ("buffer" == m || "byteLength" == m || "byteOffset" == m) || c(m, h)) || v.push(m);
      return v
    }
    var o = n("uieL"),
      i = n("1Yb9"),
  ...
  "GH3+": function(t, e, n) {
    e = t.exports = n("FZ+f")(void 0), e.push([t.i, ".tab-line[data-v-69d06f40]{display:block}.tab-label[data-v-69d06f40]{font-size:11px}", ""])
  },
  GHBc: function(t, e, n) {
    "use strict";
    var r = n("cGG2");
  ...
  "I3G/": function(t, e, n) {
    ...
    (function(e) {
      ...
      function O(t, e, n) {
        ...
        else if (!ri || "undefined" == typeof console) throw t
      }
      ...
      function R(t, e) {
        if (s(t)) {
          var n;
          return h(t, "__ob__") && t.__ob__ instanceof ji ? n = t.__ob__ : ki.shouldConvert && !mi() && (Array.isArray(t) || c(t)) && Object.isExtensible(t) && !t._isVue && (n = new ji(t)), e && n && n.vmCount++, n
        }
      }
      ...
      function P(t, e, n, r, o) {
        ...
        if (!a || !1 !== a.configurable) {
          ...
          Object.defineProperty(t, e, {
            ...
            get: function() {
              var e = s ? s.call(t) : n;
              return xi.target && (i.depend(), u && u.dep.depend(), Array.isArray(e) && D(e)), e
            },
            set: function(e) {
              var r = s ? s.call(t) : n;
      ...
      function I(t, e) {
        if (!e) return t;
        for (var n, r, o, i = Object.keys(e), a = 0; a < i.length; a++) n = i[a], r = t[n], o = e[n], h(t, n) ? c(r) && c(o) && I(r, o) : M(t, n, o);
        return t
      }
      ...
      function H(t) {
        ...
        if (e) {
          var n, r, o, i = {};
          if (Array.isArray(e))
            for (n = e.length; n--;) "string" == typeof(r = e[n]) && (o = Ho(r), i[o] = {
              type: null
            });
          else if (c(e))
            for (var a in e) r = e[a], o = Ho(a), i[o] = c(r) ? r : {
              type: r
            };
          t.props = i
        }
      ...
      function z(t, e, n) {
        ...
        "function" == typeof e && (e = e.options), H(e), V(e), q(e);
        var o = e.extends;
      ...
      function W(t, e, n, r) {
        var o = e[t],
          i = !h(n, t),
          a = n[t];
        if (K(Boolean, o.type) && (i && !h(o, "default") ? a = !1 : K(String, o.type) || "" !== a && a !== zo(t) || (a = !0)), void 0 === a) {
          a = Z(r, o, t);
      ...
      function wt(t, e, n) {
        t.$el = e, t.$options.render || (t.$options.render = Li), jt(t, "beforeMount");
        var r;
        return r = function() {
          t._update(t._render(), n)
        }, t._watcher = new Hi(t, r, x), n = !1, null == t.$vnode && (t._isMounted = !0, jt(t, "mounted")), t
      }
      ...
      function Ot() {
        Ui = Mi.length = Bi.length = 0, Di = {}, Ii = Fi = !1
      }
      ...
      function Tt() {
        ...
        for (Mi.sort(function(t, e) {
            return t.id - e.id
          }), Ui = 0; Ui < Mi.length; Ui++) t = Mi[Ui], e = t.id, Di[e] = null, t.run();
        var n = Bi.slice(),
          r = Mi.slice();
        Ot(), Nt(n), Et(r), yi && Yo.devtools && yi.emit("flush")
      }
      ...
      function Lt(t) {
        ...
        if (null == Di[e]) {
          if (Di[e] = !0, Fi) {
            for (var n = Mi.length - 1; n > Ui && Mi[n].id > t.id;) n--;
            Mi.splice(n + 1, 0, t)
          } else Mi.push(t);
          Ii || (Ii = !0, bi(Tt))
        }
      ...
      function Mt(t, e, n) {
        qi.get = function() {
          ...
          this[e][n] = t
        }, Object.defineProperty(t, n, qi)
      }

      function Bt(t) {
        t._watchers = [];
        var e = t.$options;
        e.props && Dt(t, e.props), e.methods && Vt(t, e.methods), e.data ? It(t) : R(t._data = {}, !0), e.computed && Ut(t, e.computed), e.watch && e.watch !== li && qt(t, e.watch)
      }
      ...
      function Ut(t, e) {
        ...
        for (var r in e) {
          ...
          n[r] = new Hi(t, i || x, x, zi), r in t || Gt(t, r, o)
        }
      }

      function Gt(t, e, n) {
        "function" == typeof n ? (qi.get = Ht(e), qi.set = x) : (qi.get = n.get ? !1 !== n.cache ? Ht(e) : n.get : x, qi.set = n.set ? n.set : x), Object.defineProperty(t, e, qi)
      }
      ...
      function Yt(t, e, i, a, c) {
        if (!n(t)) {
          ...
          if (s(t) && (t = u.extend(t)), "function" == typeof t) {
            ...
            return new Ei("vue-component-" + t.cid + (v ? "-" + v : ""), e, void 0, void 0, void 0, i, {
              Ctor: t,
              propsData: l,
              listeners: p,
              tag: c,
      ...
      function oe(t, e, n, o, i) {
        ...
        Array.isArray(o) && "function" == typeof o[0] && (n = n || {}, n.scopedSlots = {
          default: o[0]
        }, o.length = 0), i === Xi ? o = st(o) : i === Zi && (o = at(o));
        var a, s;
        if ("string" == typeof e) {
          var c;
          s = Yo.getTagNamespace(e), a = Yo.isReservedTag(e) ? new Ei(Yo.parsePlatformTagName(e), n, o, void 0, void 0, t) : r(c = J(t.$options, "components", e)) ? Yt(c, n, t, o, e) : new Ei(e, n, o, void 0, void 0, t)
        } else a = Yt(e, n, t, o);
      ...
      function me(t) {
        ...
        var e = t.$vnode = t.$options._parentVnode,
          n = e && e.context;
        t.$slots = gt(t.$options._renderChildren, n), t.$scopedSlots = Qo, t._c = function(e, n, r, o) {
          return re(t, e, n, r, o, !1)
        }, t.$createElement = function(e, n, r, o) {
          return re(t, e, n, r, o, !0)
        };
        var r = e && e.data;
        P(t, "$attrs", r && r.attrs, null, !0), P(t, "$listeners", t.$options._parentListeners, null, !0)
      }
      ...
      function ge(t) {
        ...
        if (t.super) {
          ...
          if (n !== t.superOptions) {
            t.superOptions = n;
            var r = be(t);
            r && b(t.extendOptions, r), e = t.options = z(n, t.extendOptions), e.name && (e.components[e.name] = t)
          }
        }
        return e
      }
      ...
      function $e(t) {
        ...
        t.extend = function(t) {
          ...
          return a.prototype = Object.create(n.prototype), a.prototype.constructor = a, a.cid = e++, a.options = z(n.options, t), a.super = n, a.options.props && Ae(a), a.options.computed && ke(a), a.extend = n.extend, a.mixin = n.mixin, a.use = n.use, Xo.forEach(function(t) {
            a[t] = n[t]
      ...
      function Me(t) {
        return Array.isArray(t) ? Be(t) : s(t) ? De(t) : "string" == typeof t ? t : ""
      }
      ...
      function sn(t, e) {
        ...
        if (!t) return n;
        var r, o;
        for (r = 0; r < t.length; r++) o = t[r], o.modifiers || (o.modifiers = Ea), n[cn(o)] = o, o.def = J(e.$options, "directives", o.name, !0);
        return n
      }
      ...
      function fn(t, e) {
        ...
        if (!(r(o) && !1 === o.Ctor.options.inheritAttrs || n(t.data.attrs) && n(e.data.attrs))) {
          ...
          for (i in c) n(u[i]) && (ma(i) ? s.removeAttributeNS(ha, ya(i)) : da(i) || s.removeAttribute(i))
        }
      }
      ...
      function pn(t, e) {
        ...
        if (!(n(i.staticClass) && n(i.class) && (n(a) || n(a.staticClass) && n(a.class)))) {
          ...
          r(c) && (s = Pe(s, Me(c))), s !== o._prevClass && (o.setAttribute("class", s), o._prevClass = s)
        }
      }
      ...
      function An(t) {
        ...
        for (; !jn();) ra = kn(), On(ra) ? En(ra) : 91 === ra && Tn(ra);
        return {
      ...
      function Sn(t, e, n) {
        ...
        else if ("input" === i && "checkbox" === a) Nn(t, r, o);
        else if ("input" === i && "radio" === a) Ln(t, r, o);
        else if ("input" === i || "textarea" === i) Pn(t, r, o);
        else if (!Yo.isReservedTag(i)) return Cn(t, r, o), !1;
        return !0
      }
      ...
      function Nn(t, e, n) {
        ...
        yn(t, "checked", "Array.isArray(" + e + ")?_i(" + e + "," + o + ")>-1" + ("true" === i ? ":(" + e + ")" : ":_q(" + e + "," + i + ")")), _n(t, Ma, "var $$a=" + e + ",$$el=$event.target,$$c=$$el.checked?(" + i + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + o + ")" : o) + ",$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(" + e + "=$$a.concat($$v))}else{$$i>-1&&(" + e + "=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{" + $n(e, "$$c") + "}", null, !0)
      }

      function Ln(t, e, n) {
        var r = n && n.number,
          o = xn(t, "value") || "null";
        o = r ? "_n(" + o + ")" : o, yn(t, "checked", "_q(" + e + "," + o + ")"), _n(t, Ma, $n(e, o), null, !0)
      }
      ...
      function Pn(t, e, n) {
        var r = t.attrsMap.type,
          ...
          s = o.trim,
          c = !i && "range" !== r,
          u = i ? "change" : "range" === r ? Pa : "input",
          f = "$event.target.value";
        s && (f = "$event.target.value.trim()"), a && (f = "_n(" + f + ")");
        var l = $n(e, f);
        c && (l = "if($event.target.composing)return;" + l), yn(t, "value", "(" + e + ")"), _n(t, u, l, null, !0), (s || a) && _n(t, "blur", "$forceUpdate()")
      }

      function Mn(t) {
        var e;
        r(t[Pa]) && (e = ii ? "change" : "input", t[e] = [].concat(t[Pa], t[e] || []), delete t[Pa]), r(t[Ma]) && (e = fi ? "click" : "change", t[e] = [].concat(t[Ma], t[e] || []), delete t[Ma])
      }
      ...
      function In(t, e) {
        if (!n(t.data.on) || !n(e.data.on)) {
          var r = e.data.on || {},
            o = t.data.on || {};
          ca = e.elm, Mn(r), nt(r, o, Bn, Dn, e.context)
        }
      }
      ...
      function Un(t, e, n) {
        return !t.composing && ("option" === e.tag || Gn(t, n) || Hn(t, n))
      }
      ...
      function qn(t) {
        return Array.isArray(t) ? _(t) : "string" == typeof t ? Ia(t) : t
      }
      ...
      function Jn(t, e) {
        ...
        if (!(n(o.staticStyle) && n(o.style) && n(i.staticStyle) && n(i.style))) {
          ...
          var d = zn(e, !0);
          for (s in l) n(d[s]) && Ga(c, s, "");
          for (s in d)(a = d[s]) !== l[s] && Ga(c, s, null == a ? "" : a)
        }
      }
      ...
      function Xn(t) {
        if (t) {
          if ("object" == typeof t) {
            var e = {};
            return !1 !== t.css && b(e, za(t.name || "v")), b(e, t), e
          }
      ...
      function er(t, e) {
        var n, r = window.getComputedStyle(t),
          ...
          f = 0,
          l = 0;
        return e === Wa ? a > 0 && (n = Wa, f = a, l = i.length) : e === Za ? u > 0 && (n = Za, f = u, l = c.length) : (f = Math.max(a, u), n = f > 0 ? a > u ? Wa : Za : null, l = n ? n === Wa ? i.length : c.length : 0), {
          type: n,
          timeout: f,
          propCount: l,
          hasTransform: n === Wa && es.test(r[Xa + "Property"])
        }
      }
      ...
      function or(t, e) {
        ...
        if (!n(i) && !r(o._enterCb) && 1 === o.nodeType) {
          for (var a = i.css, c = i.type, u = i.enterClass, f = i.enterToClass, l = i.enterActiveClass, d = i.appearClass, v = i.appearToClass, h = i.appearActiveClass, m = i.beforeEnter, y = i.enter, g = i.afterEnter, b = i.enterCancelled, _ = i.beforeAppear, x = i.appear, w = i.afterAppear, C = i.appearCancelled, A = i.duration, k = Pi, j = Pi.$vnode; j && j.parent;) j = j.parent, k = j.context;
          ...
          if (!O || x || "" === x) {
            var T = O && d ? d : u,
              ...
              S = O && v ? v : f,
              N = O ? _ || m : m,
              L = O && "function" == typeof x ? x : y,
              R = O ? w || g : g,
              P = O ? C || b : b,
              M = p(s(A) ? A.enter : A),
              B = !1 !== a && !ai,
              D = sr(L),
              I = o._enterCb = $(function() {
                B && (Qn(o, S), Qn(o, E)), I.cancelled ? (B && Qn(o, T), P && P(o)) : R && R(o), o._enterCb = null
              });
            t.data.show || rt(t.data.hook || (t.data.hook = {}), "insert", function() {
              var e = o.parentNode,
                n = e && e._pending && e._pending[t.key];
              n && n.tag === t.tag && n.elm._leaveCb && n.elm._leaveCb(), L && L(o, I)
            }), N && N(o), B && (Yn(o, T), Yn(o, E), Kn(function() {
              Yn(o, S), Qn(o, T), I.cancelled || D || (ar(M) ? setTimeout(I, M) : tr(o, c, I))
            })), t.data.show && (e && e(), L && L(o, I)), B || D || I()
          }
        }
      }
      ...
      function ir(t, e) {
        function o() {
          C.cancelled || (t.data.show || ((i.parentNode._pending || (i.parentNode._pending = {}))[t.key] = t), v && v(i), _ && (Yn(i, f), Yn(i, d), Kn(function() {
            Yn(i, l), Qn(i, f), C.cancelled || x || (ar(w) ? setTimeout(C, w) : tr(i, u, C))
          })), h && h(i, C), _ || x || C())
        }
        var i = t.elm;
        ...
        if (!r(i._leaveCb) && 1 === i.nodeType) {
          var c = a.css,
            ...
            C = i._leaveCb = $(function() {
              i.parentNode && i.parentNode._pending && (i.parentNode._pending[t.key] = null), _ && (Qn(i, l), Qn(i, d)), C.cancelled ? (_ && Qn(i, f), y && y(i)) : (e(), m && m(i)), i._leaveCb = null
            });
          g ? g(o) : o()
        }
      }
      ...
      function ur(t, e, n) {
        ...
        if (!o || Array.isArray(r)) {
          for (var i, a, s = 0, c = t.options.length; s < c; s++)
            if (a = t.options[s], o) i = C(r, fr(a)) > -1, a.selected !== i && (a.selected = i);
      ...
      function jr(t, e) {
        ...
        if (n) {
          t.staticStyle = JSON.stringify(Ia(n))
        }
        var r = xn(t, "style", !1);
        r && (t.styleBinding = r)
      }
        ...
        for (var o, i, a = [], s = e.expectHTML, c = e.isUnaryTag || Jo, u = e.canBeLeftOpenTag || Jo, f = 0; t;) {
          if (o = t, i && Ys(i)) {
            ...
            if (0 === h) {
              ...
              var x = function() {
                ...
                if (e) {
                  ...
                  n(e[0].length);
                  for (var o, i; !(o = t.match(Ms)) && (i = t.match(Ns));) n(i[0].length), r.attrs.push(i);
              ...
              if (x) {
                ! function(t) {
                  ...
                  for (var f = c(n) || !!o, l = t.attrs.length, p = new Array(l), d = 0; d < l; d++) {
                    ...
                    p[d] = {
                      name: v[1],
                      value: Sr(h, e.shouldDecodeNewlines)
                    }
                  }
                  f || (a.push({
                    tag: n,
            ...
            var w = void 0,
              ...
              $ = void 0;
            if (h >= 0) {
              for (C = t.slice(h); !(Bs.test(C) || Ps.test(C) || Is.test(C) || Fs.test(C) || ($ = C.indexOf("<", 1)) < 0);) h += $, C = t.slice(h);
      ...
      function Lr(t, e) {
        ...
        Gs = e.warn || hn, Js = e.isPreTag || Jo, Ws = e.mustUseProp || Jo, Zs = e.getTagNamespace || Jo, Vs = mn(e.modules, "transformNode"), qs = mn(e.modules, "preTransformNode"), zs = mn(e.modules, "postTransformNode"), Hs = e.delimiters;
        var r, o, i = [],
        ...
        return Nr(t, {
          ...
          start: function(t, a, u) {
            ...
            f && (l.ns = f), Kr(l) && !mi() && (l.forbidden = !0);
            for (var p = 0; p < qs.length; p++) qs[p](l, e);
            if (s || (Rr(l), l.pre && (s = !0)), Js(l.tag) && (c = !0), s) Pr(l);
            else {
              Dr(l), Ir(l), Hr(l), Mr(l), l.plain = !l.key && !a.length, Br(l), Vr(l), qr(l);
              for (var d = 0; d < Vs.length; d++) Vs[d](l, e);
              zr(l)
            }
            if (r ? i.length || r.if && (l.elseif || l.else) && Gr(r, {
                exp: l.elseif,
                block: l
              }) : r = l, o && !l.forbidden)
              if (l.elseif || l.else) Fr(l, o);
              else if (l.slotScope) {
              o.plain = !1;
            ...
            u ? n(l) : (o = l, i.push(l));
            for (var h = 0; h < zs.length; h++) zs[h](l, e)
          },
          end: function() {
            var t = i[i.length - 1],
          ...
          chars: function(t) {
            if (o && (!ii || "textarea" !== o.tag || o.attrsMap.placeholder !== t)) {
              var e = o.children;
              if (t = c || t.trim() ? Xr(o) ? t : pc(t) : a && e.length ? " " : "") {
                var n;
                !s && " " !== t && (n = $r(t, Hs)) ? e.push({
                  type: 2,
                  expression: n,
      ...
      function zr(t) {
        ...
        for (e = 0, n = c.length; e < n; e++)
          if (r = o = c[e].name, i = c[e].value, ac.test(r))
            if (t.hasBindings = !0, a = Wr(r), a && (r = r.replace(lc, "")), fc.test(r)) r = r.replace(fc, ""), i = dn(i), s = !1, a && (a.prop && (s = !0, "innerHtml" === (r = Ho(r)) && (r = "innerHTML")), a.camel && (r = Ho(r)), a.sync && _n(t, "update:" + Ho(r), $n(i, "$event"))), s || !t.component && Ws(t.tag, t.attrsMap.type, r) ? yn(t, r, i) : gn(t, r, i);
            else if (ic.test(r)) r = r.replace(ic, ""), _n(t, r, i, a, !1, Gs);
        else {
          r = r.replace(ac, "");
          var u = r.match(uc),
            f = u && u[1];
      ...
      function Yr(t) {
        for (var e = [], n = 0; n < t.length; n++) {
          var r = t[n];
          dc.test(r.name) || (r.name = r.name.replace(vc, ""), e.push(r))
        }
        return e
      }

      function Qr(t, e) {
        t && (Xs = hc(e.staticKeys || ""), Ks = e.isReservedTag || Jo, eo(t), no(t, !1))
      }
      ...
      function no(t, e) {
        if (1 === t.type) {
          ...
          if (t.staticRoot = !1, t.children)
            for (var n = 0, r = t.children.length; n < r; n++) no(t.children[n], e || !!t.for);
          if (t.ifConditions)
            for (var o = 1, i = t.ifConditions.length; o < i; o++) no(t.ifConditions[o].block, e)
        }
      }

      function ro(t) {
        return 2 !== t.type && (3 === t.type || !(!t.pre && (t.hasBindings || t.if || t.for || Io(t.tag) || !Ks(t.tag) || oo(t) || !Object.keys(t).every(Xs))))
      }
        ...
        if ("template" !== t.tag || t.slotTarget) {
          ...
          if (t.component) n = No(t.component, t, e);
            ...
            var r = t.plain ? void 0 : bo(t, e),
              o = t.inlineTemplate ? null : Ao(t, e, !0);
            n = "_c('" + t.tag + "'" + (r ? "," + r : "") + (o ? "," + o : "") + ")"
          }
      ...
      function bo(t, e) {
        ...
        if (t.attrs && (n += "attrs:{" + Lo(t.attrs) + "},"), t.props && (n += "domProps:{" + Lo(t.props) + "},"), t.events && (n += io(t.events, !1, e.warn) + ","), t.nativeEvents && (n += io(t.nativeEvents, !0, e.warn) + ","), t.slotTarget && (n += "slot:" + t.slotTarget + ","), t.scopedSlots && (n += wo(t.scopedSlots, e) + ","), t.model && (n += "model:{value:" + t.model.value + ",callback:" + t.model.callback + ",expression:" + t.model.expression + "},"), t.inlineTemplate) {
          var i = xo(t, e);
          i && (n += i + ",")
        }
      ...
      function Co(t, e, n) {
        return e.for && !e.forProcessed ? $o(t, e, n) : "{key:" + t + ",fn:function(" + String(e.attrsMap.scope) + "){return " + ("template" === e.tag ? Ao(e, n) || "void 0" : po(e, n)) + "}}"
      }
      ...
      function Oo(t, e) {
        return 1 === t.type ? po(t, e) : 3 === t.type && t.isComment ? Eo(t) : To(t)
      }
      ...
      function No(t, e, n) {
        var r = e.inlineTemplate ? null : Ao(e, n, !0);
      ...
      function Mo(t) {
        ...
        return function(n, r, o) {
          ...
          var a = t(n, r),
            s = {},
            c = [];
          return s.render = Po(a.render, c), s.staticRenderFns = a.staticRenderFns.map(function(t) {
            return Po(t, c)
          }), e[i] = s
        }
      }
      ...
      var Do = Object.prototype.toString,
        ...
        Go = /-(\w)/g,
        Ho = m(function(t) {
          return t.replace(Go, function(t, e) {
        ...
        qo = /([^-])([A-Z])/g,
        zo = m(function(t) {
          return t.replace(qo, "$1-$2").replace(qo, "$1-$2").toLowerCase()
        }),
        Jo = function(t, e, n) {
          return !1
        },
        ...
        Zo = "data-server-rendered",
        Xo = ["component", "directive", "filter"],
        Ko = ["beforeCreate", "created", "beforeMount", "mounted", "beforeUpdate", "updated", "beforeDestroy", "destroyed", "activated", "deactivated"],
        Yo = {
      ...
      var vi, hi, mi = function() {
          return void 0 === vi && (vi = !ri && void 0 !== e && "server" === e.process.env.VUE_ENV), vi
        },
        yi = ri && window.__VUE_DEVTOOLS_GLOBAL_HOOK__,
        gi = "undefined" != typeof Symbol && T(Symbol) && "undefined" != typeof Reflect && T(Reflect.ownKeys),
        bi = function() {
          function t() {
            r = !1;
            var t = n.slice(0);
      ...
      hi = "undefined" != typeof Set && T(Set) ? Set : function() {
        function t() {
      ...
      var Oi = Yo.optionMergeStrategies;
      ...
      }, Object.defineProperties(Ei.prototype, Si);
      var Ni, Li = function(t) {
          void 0 === t && (t = "");
          var e = new Ei;
        ...
        Gi = 0,
        Hi = function(t, e, n, r) {
          this.vm = t, t._watchers.push(this), r ? (this.deep = !!r.deep, this.user = !!r.user, this.lazy = !!r.lazy, this.sync = !!r.sync) : this.deep = this.user = this.lazy = this.sync = !1, this.cb = n, this.id = ++Gi, this.active = !0, this.dirty = this.lazy, this.deps = [], this.newDeps = [], this.depIds = new hi, this.newDepIds = new hi, this.expression = "", "function" == typeof e ? this.getter = e : (this.getter = j(e), this.getter || (this.getter = function() {})), this.value = this.lazy ? void 0 : this.get()
        };
        ...
        Ji = {
          init: function(t, e, n, r) {
            if (!t.componentInstance || t.componentInstance._isDestroyed) {
              (t.componentInstance = Qt(t, Pi, n, r)).$mount(e ? t.elm : void 0, e)
          ...
          insert: function(t) {
            ...
            n._isMounted || (n._isMounted = !0, jt(n, "mounted")), t.data.keepAlive && (e._isMounted ? St(n) : At(n, !0))
          },
          destroy: function(t) {
      ...
      ! function(t) {
        t.prototype._init = function(t) {
          var e = this;
          e._uid = Ki++, e._isVue = !0, t && t._isComponent ? ye(e, t) : e.$options = z(ge(e.constructor), t || {}, e), e._renderProxy = e, e._self = e, xt(e), vt(e), me(e), jt(e, "beforeCreate"), Wt(e), Bt(e), Jt(e), jt(e, "created"), e.$options.el && e.$mount(e.$options.el)
        }
      }(xe),
      function(t) {
        var e = {};
        ...
        n.get = function() {
          return this._props
        }, Object.defineProperty(t.prototype, "$data", e), Object.defineProperty(t.prototype, "$props", n), t.prototype.$set = M, t.prototype.$delete = B, t.prototype.$watch = function(t, e, n) {
          var r = this;
      ...
      function(t) {
        t.prototype._update = function(t, e) {
          ...
          var r = n.$el,
            o = n._vnode,
            i = Pi;
          Pi = n, n._vnode = t, o ? n.$el = n.__patch__(o, t) : (n.$el = n.__patch__(n.$el, t, e, !1, n.$options._parentElm, n.$options._refElm), n.$options._parentElm = n.$options._refElm = null), Pi = i, r && (r.__vue__ = null), n.$el && (n.$el.__vue__ = n), n.$vnode && n.$parent && n.$vnode === n.$parent._vnode && (n.$parent.$el = n.$el)
      ...
      function(t) {
        ...
        }, t.prototype._o = pe, t.prototype._n = p, t.prototype._s = l, t.prototype._l = ae, t.prototype._t = se, t.prototype._q = w, t.prototype._i = C, t.prototype._m = le, t.prototype._f = ce, t.prototype._k = ue, t.prototype._b = fe, t.prototype._v = Y, t.prototype._e = Li, t.prototype._u = _t, t.prototype._g = he
      }(xe);
      ...
      ! function(t) {
        ...
        e.get = function() {
          ...
          mergeOptions: z,
          defineReactive: P
        }, t.set = M, t.delete = B, t.nextTick = bi, t.options = Object.create(null), Xo.forEach(function(e) {
          t.options[e + "s"] = Object.create(null)
        }), t.options._base = t, b(t.options.components, ta), we(t), Ce(t), $e(t), je(t)
      ...
      var ea, na, ra, oa, ia, aa, sa, ca, ua, fa = d("style,class"),
        ...
        Ya = "animation",
        Qa = "animationend";
      Ja && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Xa = "WebkitTransition", Ka = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (Ya = "WebkitAnimation", Qa = "webkitAnimationEnd"));
      var ts = ri && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout,
        ...
        is = function(t) {
          ...
          function c(t, e, n, i, a) {
            if (t.isRootInsert = !a, !u(t, e, n, i)) {
              var s = t.data,
                c = t.children,
                f = t.tag;
              r(f) ? (t.elm = t.ns ? E.createElementNS(t.ns, f) : E.createElement(f, t), y(t), v(t, c, e), r(s) && m(t, e), p(n, t.elm, i)) : o(t.isComment) ? (t.elm = E.createComment(t.text), p(n, t.elm, i)) : (t.elm = E.createTextNode(t.text), p(n, t.elm, i))
            }
          }
          ...
          function l(t, e, n, o) {
            for (var i, a = t; a.componentInstance;)
              if (a = a.componentInstance._vnode, r(i = a.data) && r(i = i.transition)) {
                for (i = 0; i < O.activate.length; ++i) O.activate[i](ja, a);
                e.push(a);
                break
              }
            p(n, t.elm, o)
          ...
          function m(t, e) {
            for (var n = 0; n < O.create.length; ++n) O.create[n](ja, t);
          ...
          function y(t) {
            ...
            r(e = Pi) && e !== t.context && r(e = e.$options._scopeId) && E.setAttribute(t.elm, e, "")
          }
          ...
          function x(t, e) {
            if (r(e) || r(t.data)) {
              ...
              for (r(e) ? e.listeners += o : e = i(t.elm, o), r(n = t.componentInstance) && r(n = n._vnode) && r(n.data) && x(n, e), n = 0; n < O.remove.length; ++n) O.remove[n](t, e);
              r(n = t.data.hook) && r(n = n.remove) ? n(t, e) : e()
            } else s(t.elm)
          }

          function w(t, e, o, i, a) {
            for (var s, u, f, l, p = 0, d = 0, v = e.length - 1, h = e[0], m = e[v], y = o.length - 1, b = o[0], x = o[y], w = !a; p <= v && d <= y;) n(h) ? h = e[++p] : n(m) ? m = e[--v] : en(h, b) ? (C(h, b, i), h = e[++p], b = o[++d]) : en(m, x) ? (C(m, x, i), m = e[--v], x = o[--y]) : en(h, x) ? (C(h, x, i), w && E.insertBefore(t, h.elm, E.nextSibling(m.elm)), h = e[++p], x = o[--y]) : en(m, b) ? (C(m, b, i), w && E.insertBefore(t, m.elm, h.elm), m = e[--v], b = o[++d]) : (n(s) && (s = rn(e, p, v)), u = r(b.key) ? s[b.key] : null, n(u) ? (c(b, i, t, h.elm), b = o[++d]) : (f = e[u], en(f, b) ? (C(f, b, i), e[u] = void 0, w && E.insertBefore(t, f.elm, h.elm), b = o[++d]) : (c(b, i, t, h.elm), b = o[++d])));
            p > v ? (l = n(o[y + 1]) ? null : o[y + 1].elm, g(t, l, o, d, y, i)) : d > y && _(t, e, p, v)
          }
          ...
          function C(t, e, i, a) {
            if (t !== e) {
              ...
              n(e.text) ? r(f) && r(l) ? f !== l && w(s, f, l, i, a) : r(l) ? (r(t.text) && E.setTextContent(s, ""), g(s, null, l, 0, l.length - 1, i)) : r(f) ? _(s, f, 0, f.length - 1) : r(t.text) && E.setTextContent(s, "") : t.text !== e.text && E.setTextContent(s, e.text), r(u) && r(c = u.hook) && r(c = c.postpatch) && c(t, e)
            }
          }
          ...
          for (k = 0; k < Oa.length; ++k)
            for (O[Oa[k]] = [], j = 0; j < T.length; ++j) r(T[j][Oa[k]]) && O[Oa[k]].push(T[j][Oa[k]]);
          ...
          return function(t, i, a, s, u, f) {
            ...
            if (n(t)) l = !0, c(i, p, u, f);
              ...
              var d = r(t.nodeType);
              if (!d && en(t, i)) C(t, i, p, s);
              else {
                if (d) {
                  if (1 === t.nodeType && t.hasAttribute(Zo) && (t.removeAttribute(Zo), a = !0), o(a) && A(t, i, p)) return $(i, p, !0), t;
                  t = e(t)
                }
                var v = t.elm,
                  m = E.parentNode(v);
                if (c(i, p, v._leaveCb ? null : m, E.nextSibling(v)), r(i.parent)) {
                  for (var y = i.parent; y;) y.elm = i.elm, y = y.parent;
                  if (h(i))
                    for (var g = 0; g < O.create.length; ++g) O.create[g](ja, i.parent)
                }
      ...
      var ss = {
        ...
        cs = {
          ...
          update: function(t, e, n) {
            var r = e.value;
            r !== e.oldValue && (n = vr(n), n.data && n.data.transition ? (n.data.show = !0, r ? or(n, function() {
          ...
          render: function(t) {
            ...
            if (n && (n = n.filter(function(t) {
              ...
              if (i.data.directives && i.data.directives.some(function(t) {
                  return "show" === t.name
                }) && (i.data.show = !0), f && f.data && !br(i, f) && !_r(f)) {
      ...
      var ds = {
          ...
          updated: function() {
            ...
            if (t.length && this.hasMove(t[0].elm, e)) {
              t.forEach(xr), t.forEach(wr), t.forEach(Cr);
              var n = document.body;
              n.offsetHeight;
              t.forEach(function(t) {
                if (t.data.moved) {
                  var n = t.elm,
                    r = n.style;
                  Yn(n, e), r.transform = r.WebkitTransform = r.transitionDuration = "", n.addEventListener(Ka, n._moveCb = function t(r) {
                    r && !/transform$/.test(r.propertyName) || (n.removeEventListener(Ka, t), n._moveCb = null, Qn(n, e))
                  })
                }
              })
            }
      ...
      xe.config.mustUseProp = pa, xe.config.isReservedTag = Ca, xe.config.isReservedAttr = fa, xe.config.getTagNamespace = Ie, xe.config.isUnknownElement = Fe, b(xe.options.directives, us), b(xe.options.components, vs), xe.prototype.__patch__ = ri ? is : x, xe.prototype.$mount = function(t, e) {
        return t = t && ri ? Ue(t) : void 0, wt(this, t, e)
      }, setTimeout(function() {
        Yo.devtools && yi && yi.emit("init", xe)
      }, 0);
      var hs, ms = !!ri && function(t, e) {
        ...
        $s = d("area,base,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wbr"),
        ...
        Ns = new RegExp("^\\s*" + Ts.source + "(?:\\s*(" + Es.source + ")\\s*(?:" + Ss.join("|") + "))?"),
        Ls = "[a-zA-Z_][\\w\\-\\.]*",
        Rs = "((?:" + Ls + "\\:)?" + Ls + ")",
        Ps = new RegExp("^<" + Rs),
        Ms = /^\s*(\/?)>/,
      ...
      var Gs, Hs, Vs, qs, zs, Js, Ws, Zs, Xs, Ks, Ys = d("script,style,textarea", !0),
        Qs = {},
        tc = {
          "&lt;": "<",
          "&gt;": ">",
        ...
        wc = function(t) {
          this.options = t, this.warn = t.warn || hn, this.transforms = mn(t.modules, "transformCode"), this.dataGenFns = mn(t.modules, "genData"), this.directives = b(b({}, xc), t.directives);
        ...
        $c = Cc(js),
        Ac = $c.compileToFunctions,
        kc = m(function(t) {
          var e = Ue(t);
          return e && e.innerHTML
        }),
        jc = xe.prototype.$mount;
  ...
  O3gb: function(t, e, n) {
    function r(t, e, n) {
      e = (n ? i(t, e, n) : void 0 === e) ? 1 : c(a(e), 0);
      var r = null == t ? 0 : t.length;
      if (!r || e < 1) return [];
      for (var u = 0, f = 0, l = Array(s(r / e)); u < r;) l[f++] = o(t, u, u += e);
      return l
    }
    var o = n("M1c9"),
      i = n("zBOP"),
  ...
  Rk7i: function(t, e, n) {
    e = t.exports = n("FZ+f")(void 0), e.push([t.i, ".tab-section[data-v-7643fb9a]{width:100%;padding:0 10px}.tab-row[data-v-7643fb9a]{padding-bottom:10px}.tab-row .bar[data-v-7643fb9a]{float:left}", ""])
  },
  S7p9: function(t, e) {
    function n(t) {
      return function(e) {
  ...
  THYH: function(t, e, n) {
    ...
    var r = n("/Z8c"),
      ...
      s = n.n(a),
      c = {};
    c.desiredLength = 4 * r.a.BEATS_PER_BAR, c.fitToBar = function(t) {
      if (t.length < 1 && (t = "-"), t = i()(t, c.desiredLength / t.length), t.length < c.desiredLength) {
        var e = c.desiredLength - t.length;
        t += t.substring(0, e)
      } else t = t.substring(0, c.desiredLength);
      return t
    }, c.random = function() {
      for (var t = "x", e = 0; e < c.desiredLength - 1; e++) t += s()(1) > 0 ? "x" : "-";
      return t
    };
    var u = c,
      f = {};
    f.Character = {}, f.Character.next = function(t) {
      return String.fromCharCode(t.charCodeAt() + 1)
    }, f.Character.previous = function(t) {
      return String.fromCharCode(t.charCodeAt() - 1)
    }, f.JSON = {}, f.JSON.prettyPrint = function(t) {
    ...
    var l = f,
      ...
      h = n.n(v),
      m = {};
    m.FLAT = "b", m.SHARP = "#", m.convertAccidental = function(t) {
      if (1 === t.length) return d()(t);
      var e = d()(t.charAt(0));
      return t.charAt(1) === m.SHARP && (e = l.Character.next(e), t = e < "H" ? e : "A", ["C", "F"].includes(t) || (t += m.FLAT)), t
    }, m.isValid = function(t) {
      return "x" === t || "X" === t || ("-" === t || !isNaN(t) && (!!h()(t) || ["a", "b", "c", "d", "e", "f"].includes(t.toLowerCase())))
    };
    var y = m,
      g = n("lGpV"),
      b = n.n(g),
      ...
      j = {};
    j.findByShape = function(t) {
      var e = "?";
      return x()(A.a, function(n, r) {
        x()(n, function(n, o) {
          n.length && x()(n, function(n) {
            if (n === t) return e = r + " " + o
          })
        })
      }), e
    }, j.findByName = function(t) {
      var e = void 0,
        n = void 0;
      if (t = t.replace(/\s/g, "_").toLowerCase(), x()($.c, function(r) {
          t.includes(r) && (t = t.replace("_", ""), e = t.split(r)[0], n = r)
        }), !e && !n) {
        var r = t.split("_"),
          o = k(r, 2);
        e = o[0], n = o[1]
      }
      return void 0 === n && (n = "major"), e = y.convertAccidental(e), A.a[b()(e)][n]
    }, j.isNamed = function(t) {
      var e = !1;
      return $.c.forEach(function(n) {
        1 === n.length && (n = " " + n), t.includes(n) && (e = !0)
      }), e
    }, j.find = function(t) {
      if (j.isNamed(t)) {
        var e = j.findByName(t);
        return e.length ? C()(e) : "?"
      }
      return j.findByShape(t)
    };
    var O = j,
      T = n("/Z8c"),
      E = {};
    E.draw = function(t, e, n, r) {
      n = u.fitToBar(n);
      var o = "-",
        i = "";
      r % T.a.BEATS_PER_BAR == 0 && (i += e + "|");
      for (var a = 1, s = 0, c = 0; c < n.length; c++) {
        c >= Math.ceil(n.length / t.length) * a && (s++, a++);
        var f = t[s];
        switch (e) {
          case T.b.e:
            o = f[5];
          ...
          case T.b.E:
            o = f[0]
        }["x", "X", "-"].includes(o) || (o = parseInt("0x" + o, 16)), y.isValid(o) || (o = "-");
        o >= 10 && "-" !== n[c - 1] && void 0 !== n[c - 1] || (i += "-" !== n[c] ? o : "-")
      }
      return i += "|"
    };
    var S = E,
    ...
    e.default = {
      ...
      methods: {
        draw: function(t) {
          "random" === this.bar.pattern.toLowerCase() && (this.bar.pattern = u.random());
          var e = [];
          return this.chordShapes.forEach(function(t) {
            e.push(t.shape)
          }), S.draw(e, t, this.bar.pattern, this.index)
        }
      },
      created: function() {
        var t = this;
        this.bar.chords.forEach(function(e) {
          t.chordShapes.push({
            name: e,
            shape: O.find(e)
          })
  ...
  UVtW: function(t, e, n) {
    ...
    var o = n("VU/8")(n("THYH"), n("4JpV"), r, "data-v-69d06f40", null);
    t.exports = o.exports
  },
  UnEC: function(t, e) {
    function n(t) {
    ...
    t.exports = {
      render: function() {
        ...
        return (t._self._c || e)("footer", {
          staticClass: "footer",
          class: {
            fixed: t.fixed, "is-hidden": t.hideFooter
          }
        }, [t._m(0)])
      },
      staticRenderFns: [function() {
        ...
        }, [n("p", [n("strong", [t._v("Random Chord Progression Generator")]), n("a", {
          attrs: {
  ...
  XPuf: function(t, e, n) {
    function r(t, e, n) {
      ...
      if (n || t % 1 || e % 1) {
        var f = u();
        return c(t + f * (e - t + s("1e-" + ((f + "").length - 1))), e)
      }
      return o(t, e)
    }
    var o = n("7Mjc"),
  ...
  Xaou: function(t, e, n) {
    ...
    e.default = {
      computed: {
        bars: function() {
          return o()(this.progression, i.a.BEATS_PER_BAR)
        }
      },
      props: ["progression"]
    }
  ...
  fBP1: function(t, e) {
    ! function() {
      ...
      setInterval(function() {
        ...
        r && t || !(window.Firebug && window.Firebug.chrome && window.Firebug.chrome.isInitialized || t || r) ? (e.open && n(!1, null), e.open = !1, e.orientation = null) : (e.open && e.orientation === o || n(!0, o), e.open = !0, e.orientation = o)
      }, 500), void 0 !== t && t.exports ? t.exports = e : window.devtools = e
    }()
  },
  fuGk: function(t, e, n) {
    "use strict";
  ...
  gkE3: function(t, e, n) {
    ...
    var o = n("VU/8")(n("vaBo"), n("X5xo"), r, "data-v-1115a3a6", null);
    t.exports = o.exports
  },
  gwcX: function(t, e) {
    function n() {
  ...
  "j7/0": function(t, e, n) {
    var r = n("VU/8")(null, n("we5U"), null, null, null);
    t.exports = r.exports
  },
  k3Eb: function(t, e) {
    t.exports = {
          ...
          return n("span", {
            ...
            return n("span", {
              ...
              attrs: {
                index: r,
                bar: e,
                showChordNames: t.showChordNames
              }
            })], 1)
          }))
        }))])
  ...
  mML7: function(t, e, n) {
    ...
    var o = n("VU/8")(n("kh3E"), n("k3Eb"), r, "data-v-7643fb9a", null);
    t.exports = o.exports
  },
  mgnk: function(t, e, n) {
    function r(t) {
  ...
  pJmD: function(t, e, n) {
    function r(t, e, n) {
      return e = (n ? i(t, e, n) : void 0 === e) ? 1 : a(e), o(s(t), e)
    }
    var o = n("6qKe"),
      i = n("zBOP"),
      a = n("5Zxu"),
  ...
  "sV/x": function(t, e, n) {
    ...
    var r = n("I3G/"),
      ...
      c = n.n(s),
      u = n("+VEX");
    o.a.component("page-header", n("j7/0")), o.a.component("tab", n("mML7")), o.a.component("tab-bar", n("UVtW")), o.a.component("results", n("2EeS")), o.a.component("page-footer", n("gkE3")), new o.a({
      el: "#app",
      data: {
        root: "A",
        tonality: "major",
      ...
      methods: {
        generate: function() {
          var t = this;
          this.isLoading = !0, this.progression = !1, a.a.post("/api/generate", {
            key: this.root,
            tonality: this.tonality,
            bars: this.bars
          }).then(function(e) {
            t.progression = e.data, t.chords = e.data.map(function(t) {
              return t.chords
            }), t.isLoading = !1
          })
        },
        selectMode: function(t) {
          this.mode = t, window.localStorage.setItem("mode", t)
        }
      },
      created: function() {
        var t = this;
        this.root = c()(Object.keys(u.a)), this.tonality = c()(["major", "minor"]), this.bars = c()([4, 8]), document.addEventListener("keydown", function(e) {
          switch (e.key) {
            case "Enter":
              t.generate();
              break;
            case "t":
              var n = "table" === t.mode ? "tab" : "table";
              t.selectMode(n)
          }
        })
      }
  ...
  vaBo: function(t, e, n) {
    ...
    e.default = {
      ...
      computed: {
        hideFooter: function() {
          return this.isMobile || this.devtools.open && "horizontal" === this.devtools.orientation
        }
      },
      props: ["fixed"]
    }
    ...
    t.exports = {
      ...
      staticRenderFns: [function() {
        ...
        return n("section", {
          ...
          staticClass: "title"
        }, [t._v("Random Chord Progression Generator")]), n("h2", {
